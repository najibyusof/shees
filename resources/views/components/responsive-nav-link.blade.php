...
$classes = ($active ?? false)
            ? 'block w-full border-l-4 border-indigo-400 bg-indigo-50 py-2 ps-3 pe-4 text-start text-base font-medium text-indigo-700 transition duration-150 ease-in-out focus:border-indigo-700 focus:bg-indigo-100 focus:text-indigo-800 focus:outline-none dark:border-indigo-500 dark:bg-indigo-900/30 dark:text-indigo-200 dark:focus:border-indigo-400 dark:focus:bg-indigo-900/50 dark:focus:text-indigo-100'
