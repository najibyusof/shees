                                ...
                                <div class="flex items-end gap-3">
                                    <label class="inline-flex items-center gap-2 text-sm ui-text">
                                        <input type="checkbox" name="responses[{{ $response->id }}][is_non_compliant]"
                                            value="1" @checked(old("responses.{$response->id}.is_non_compliant", $response->is_non_compliant)) class="rounded border-slate-300 dark:border-gray-600 dark:bg-gray-800">
                                        Mark non-compliant
                                    </label>
                                    <label class="inline-flex items-center gap-2 text-sm ui-text">
