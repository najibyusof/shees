<x-guest-layout>
    ...
    <div class="mt-6 rounded-xl border border-teal-200 bg-teal-50 p-4 sm:p-5 dark:border-teal-700 dark:bg-teal-900/30">
        <h3 class="text-sm font-semibold text-teal-900 dark:text-teal-100">Demo Accounts (for testing)</h3>
        <p class="mt-1 text-xs text-teal-700 dark:text-teal-200">Use these credentials in local development environments.</p>
        <div class="mt-3 space-y-2 text-xs text-teal-900 dark:text-teal-100">
            <p><span class="font-semibold">Admin:</span> superadmin@shees.local / password</p>
            <p><span class="font-semibold">Manager:</span> olivia.hart@shees.local / password</p>
            <p><span class="font-semibold">Safety Officer:</span> sophia.tan@shees.local / password</p>
            <p><span class="font-semibold">Auditor:</span> priya.menon@shees.local / password</p>
            <p><span class="font-semibold">Supervisor:</span> noah.rivera@shees.local / password</p>
            <p><span class="font-semibold">Worker:</span> jose.villanueva@shees.local / password</p>
        </div>
    </div>

    <p class="mt-4 text-center text-sm text-slate-600 dark:text-gray-300">
        New to SHEES?
        <a href="{{ route('register') }}" class="font-semibold text-teal-700 underline underline-offset-4 transition hover:text-teal-800 dark:text-teal-300 dark:hover:text-teal-200">
            Create an account
        </a>
    </p>
</x-guest-layout>
