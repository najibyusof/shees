    ...
    public function run(): void
    {
        ...
        for ($i = 1; $i <= 20; $i++) {
            ...
            $worker = Worker::query()->create([
                ...
                'full_name' => $linkedUser?->name ?? $this->faker->name(),
                'phone' => $this->faker->phoneNumber(),
                'department' => $this->faker->randomElement(['Operations', 'Maintenance', 'Warehouse', 'Quality']),
                'position' => $this->faker->randomElement(['Operator', 'Technician', 'Inspector']),
                'status' => $this->faker->randomElement(['active', 'active', 'active', 'on-leave']),
                'geofence_center_latitude' => $this->faker->latitude(14.4, 14.8),
                'geofence_center_longitude' => $this->faker->longitude(120.8, 121.2),
            ...
            AttendanceLog::query()->create([
                ...
                'source' => $this->faker->randomElement(['gps', 'manual']),
                'device_identifier' => 'worker-device-'.$this->faker->numerify('###'),
            ...
            for ($j = 1; $j < $logCount; $j++) {
                ...
                AttendanceLog::query()->create([
                    ...
                    'speed_mps' => $this->faker->randomFloat(2, 0, 2),
                    'heading_degrees' => $this->faker->optional()->randomFloat(2, 0, 360),
                    'source' => $this->faker->randomElement(['gps', 'manual', 'api']),
                    'device_identifier' => 'worker-device-'.$this->faker->numerify('###'),
                    'external_event_id' => $this->faker->uuid(),
            ...
            $worker->update([
                'last_latitude' => $this->faker->latitude(14.4, 14.8),
                'last_longitude' => $this->faker->longitude(120.8, 121.2),
